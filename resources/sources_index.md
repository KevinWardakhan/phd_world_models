...
| DMD2 (Yin et al., 2024) | `papers/dmd2.md` | Stage B distillation: dropping the regression loss, adding the GAN loss, two-time-scale update, training stability (M4); the multi-step generator (sec 4.4) and backward simulation (sec 4.5) used for the M5 few-step stretch. |
| Di[M]O (Zhu et al.) | `papers/dimo.md` | One-step distillation perspective: student-generated states, auxiliary model, and mode-collapse / entropy considerations (informs M3-M5). |
